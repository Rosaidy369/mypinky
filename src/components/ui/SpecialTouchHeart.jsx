function SpecialTouchHeart({ size = 16, className = "" }) {
  return (
    <svg
      width={size}
      height={size}
      viewBox="0 0 24 24"
      className={`special-touch-heart ${className}`}
    >
      <defs>
        <linearGradient id="specialTouchGradient" x1="0%" y1="0%" x2="100%" y2="100%">
      ...
      <path
        ...
        fill="url(#specialTouchGradient)"
      />

      <circle cx="18" cy="4.5" r="1.1" fill="#ff3f87" opacity="0.95" />
...
export default SpecialTouchHeart;
